...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _filterData() {
    setState(() {
      if (_searchQuery.isEmpty) {
        ...
        _filteredPopularCategories = _filterByQuery(_allPopularCategories, 'productName');
        _filteredTrendingProducts = _filterByQuery(_allTrendingProducts, 'productName');
  ...
  Future<void> fetchData() async {
    ...
    QuerySnapshot popularCategoriesSnapshot = await FirebaseFirestore.instance.collection('popular_categories').get();
    QuerySnapshot trendingProductsSnapshot = await FirebaseFirestore.instance.collection('trending_products').get();
  ...
  Widget _buildPopularCategories({bool filtered = false}) {
    return SizedBox(
      ...
      child: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('popular_categories').snapshots(),
